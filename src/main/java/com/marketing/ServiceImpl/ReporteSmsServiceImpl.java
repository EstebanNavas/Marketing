...
//	private DataSource dataSource;
	...
	@Override
	public ReportesDTO ReporteEnCarpetaNotas(Map<String, Object> params, JRDataSource dataSource, String formato, 
			String xFileNameReporte, String xPathReport, String xPathPDF,  String idDcto) throws JRException, IOException, SQLException {
		...
		// Se llama al metdo export de la clase JasperReportManager para generar el archivo
		ByteArrayOutputStream stream = reportManager.exportReportCarpetaNotas(xPathReport, xFileNameReporte, formato, params, dataSource, xPathPDF,  idDcto);
