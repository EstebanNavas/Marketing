...
@Component
public class ProcesoGuardaPorcentajeDctoSoporte {
...
//					  int idEstadoTx, int idTipoTx, int idBodega, int idSubcuenta, String idCliente, int idRuta, int idEstracto)
	        ...
	        tblDctosOrdenesDetalleRepo.ingresaDetalleDctoSoporte(xIdLocalUsuario, xIdTipoOrden, xIdOrdenMax, xCantidadPedida, nombrePlu, idPlu, 5, xEstadoNoMarcado, 0, xVrUnitario,
	        										cero, cero, DescuentoComercial, xCero, xCantidadPedida, xIdLista, "0", xComentario, maximoItem, maximoItem,
	        										xCero, xCero, xIdBodega, xCero, xIdTercero, xCero, xCero, xPorcentajeRteFuente, cero, cero);
