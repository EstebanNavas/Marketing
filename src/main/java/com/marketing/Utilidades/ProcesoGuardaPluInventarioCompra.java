...
@Component
public class ProcesoGuardaPluInventarioCompra {
	...
	public int guarda(int xIdLog,
        ...
        if (idDctoExist != null) {
        	...
        	tblDctosRepo.ingresaDcto(xIdLocalUsuario, xIdTipoOrden, xIdOrdenMax, xIdDctoMax, xIndicador, strFechaVisita, xVrBase, ceroInt, 1, xVrIva, 
            		2, ceroInt, xVrCero, ceroInt, ceroInt, xNombreTercero, xIdUsuario, xIdTercero, ceroInt, ceroInt,
            		ceroInt, numeroFactura, fechaRecibo, ceroInt, ceroInt, xVrCero, xIdLocalUsuario, ceroInt, ceroInt,
