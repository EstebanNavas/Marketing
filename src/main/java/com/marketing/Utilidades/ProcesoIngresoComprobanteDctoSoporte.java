...
@Component
public class ProcesoIngresoComprobanteDctoSoporte {
...
// 			 int IdPeriodo, int IdVendedor, Double VrImpoconsumo, Double VrCostoIND, int IdOrdenCruce, int EtapaSTR, int EnvioFE)
      ...
      tblDctosRepo.ingresaDctoDctoSoporte(xIdLocal, xIdTipoOrdenNew, xIdOrdenMax, xIdDctoMax, xIndicador, xFechaCorte, xVrVentaSinDscto, xVrPago, 1, xVrIvaDou, 
    		  xIdTipoNegocio, xVrRteFuenteDou, VrDescuento, xVrRteIvaDou, xVrRteIcaDou, xNombreTercero, xIdUsuario, xIdCliente, xIdFormaPago, CeroInt, 
