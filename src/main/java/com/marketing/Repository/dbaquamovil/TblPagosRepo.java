...
public interface TblPagosRepo extends JpaRepository<TblPagos, Integer> {
	  ...
	  @Query(value = " SELECT tblpagos.idLocal,                                "
			  ...
			  + " ON tmpPRO.idLocal = tblplus.idLocal                     "
			  + " AND tmpPRO.idPlu = tblplus.idPlu                        "
			  + " where tblpagos.idlocal =  ?1                            "    
	  ...
	  @Query(value = "SELECT tblpagos.idLocal,       "
              ...
              nativeQuery = true)
	  List<TblPagosDTO> listaPagoTercero(int xIdLocal, int IdTipoOrden, String idCliente, String fechaInicial, String fechaFinal);
	  
	  
	  
	  
	  @Query(value = "SELECT tblpagos.idReciboCruce             "
              + "FROM  tblpagos                 "
              + "WHERE tblpagos.idLocal       = "
              + "?1                "
              + "AND   tblpagos.idTipoOrden   = "
              ...
              nativeQuery = true)
	  Integer validaReciboRetirado(int xIdLocal, int IdTipoOrden, int IdReciboCruce, int Indicador);
	  ...
	  @Query(value = "SELECT tblpagos.idLocal,           "
              ...
              + "AND   tblpagos.indicador   =   ?4    ",
              nativeQuery = true)
	  List<TblPagosDTO> listaUnFCH(int xIdLocal, int IdTipoOrden, int IdRecibo, int Indicador);
	  ...
	  @Query(value = "SELECT tblpagos.idLocal,         "
              ...
              + "       tblpagos.idPlanilla       ",
              nativeQuery = true)
	  List<TblPagosDTO> totalReciboFCH(int xIdLocal, int IdTipoOrden, int IdRecibo, int Indicador);
	  ...
	  @Query(value =  "		SELECT tblpagos.idLocal,                				"                
				...
				+ "   AND tblPagos.idPeriodo = tblDctos.idPeriodo                   "
				+ "   AND tblPagos.idDcto = tblDctos.idDcto                         "
				+ "	INNER JOIN tblterceros                                          "
				+ "	  ON tblterceros.idCliente =                                    "
				+ "	               tblDctos.idCliente                               "
				+ "    AND tblpagos.idLocal = tblterceros.idLocal                   "
