...
//		  Integer ObtenerIdCliente(int IDLOCAL, int IDUSUARIO);
		...
		// Modificamos el ESTADO a 1 Cuando se finaliza por completo la pqr 
		  ...
		  @Query( value = "SELECT MAX(tblterceros.nombreTercero) AS nombreTercero,      "
	                + "       MAX(tblciudades.idCiudad) AS idCiudad,                "
	                + "       MAX(tblciudades.idDpto) AS idDpto,                    "
	                + "       MAX(tbltercerossui.idIgacZona) AS idIgacZona,         "
	                + "       MAX(tbltercerossui.idIgacSector) AS idIgacSector,     "
	                ...
	                + "   		                       AS idUNoMultiusuario,    "
	                + "       MAX(tbltercerossui.idHogarComunitario)                "
	                + "   		                      AS idHogarComunitario,    "
	                ...
	                + "       MAX(tblterceros.codigoCatastral) AS numeroFicha,      "
	                + "       MAX(tbltercerossui.corregimiento)                     "
	                + "   		                           AS corregimiento,    "
	                + "       MAX(tbltercerossui.barrio) AS barrio,                 "
	                + "       MAX(tbltercerossui.edificio) AS edificio,             "
	                + "       MAX(tbltercerossui.unidadPredial)  AS unidadPredial,  "
	                + "       MAX(tmpCAU.nombreCausa) AS nombreEstadoCliente,       "
	                + "       MAX(tbldctosordenes.direccionDespacho)                "
	                + "                                  AS direccionTercero,       "
	                + "       tmpPRC.idDcto,                                        "
	                + "  	  MAX(tmpPRC.fechaDcto) AS fechaDcto,                   "
	                + "       tmpPRC.idPeriodo,                                     "
	                + "       tmpPRC.idCliente,                                     "
	                + "       SUM(tmpPRC.vrConsumo) AS vrConsumo,                   "                
	                + " ( SELECT  TOP 1                                             "              
	                ...
	                + "       SUM(tmpPRC.vrReinstalacion) AS vrReinstalacion,       "
	                + "       SUM(tmpPRC.vrSuspencion) AS vrSuspencion,  	        "
	                + "       SUM(tmpPRC.vrCargoCorte) AS vrCargoCorte,             "
	                ...
	                + "          THEN (MAX(tmpPRC.factorCargoFijo) *(-1))           "
	                + "          WHEN SUM(tmpPRC.vrSubsidio) >= 0                   "
	                + "            THEN MAX(tmpPRC.factorCargoFijo)                 "
	                + "                                 END AS factorCargoFijo      "
	                + "      ,MAX(tmpPRC.factorCargoConsumo) AS factorCargoConsumo  "
