	...
	// Modificamos el IDTIPOORDEN de 67 a 17
		...
		// Modificamos el ESTADO a 1 Cuando se finaliza por completo la pqr 
		  ...
		  @Query( value = "   SELECT tbldctos.idLocal,                                              "                   
				  ...
				  + "                            tblterceroestracto.idEstracto                "
				  + "     WHERE tbldctos.idLocal = 142                                        "     
				  + "     AND tbldctos.idPeriodo =  202402                                    "       
				  ...
				  + "     AND tbldctosordenesdetalle.idLocal   =  142                         "                   
				  + "     AND tbldctos.idPeriodo =  202402                                    "       
				  ...
				  + "    AND tbldctos.idPeriodo = 202402                                      "    
				  + "    AND tbldctos.idTipoOrden IN (9,29)                       		      "
				  + "    AND tbldctos.idCliente  IN ('1468')                                  "
				  + "                                                                         "
		  ...
		  List<TblDctosOrdenesDTO> listaUnClienteProducto(int idLocal, int IdPeriodo, String idCliente);
