...
//		  Integer ObtenerIdCliente(int IDLOCAL, int IDUSUARIO);
	...
	//ACTUAL	  
		  @Query( value = "                    SELECT tbldctos.idLocal,                                               "                                       
	                ...
	                + "              	    tblterceroestracto.nombreClaseUso,                                    "
		  ...
		  @Query( value = "                    SELECT tbldctos.idLocal,                                               "                                       
	                ...
	                + "                      tmpDET.idPlu,                                                        "                                    
	                + "                      tmpCAT.NOMBREPLU,                                                    "                                    
	                + "                    CONVERT(numeric(18,2),ROUND((tmpDET.VRVENTAUNITARIO)/                  "                                    
	                + "                    ( 1+ tmpDET.PORCENTAJEIVA/100.0 ),2))                                  "                                    
	                + "                                                AS vrBaseUnitarioSinIva,                   "                                    
	                + "                    CONVERT(numeric(18,2),ROUND((tmpDET.VRVENTAUNITARIO)/                  "                                    
	                + "                    ( 1+ tmpDET.PORCENTAJEIVA/100 ),2) *                                   "                                    
		  ...
		  @Query( value = "                    SELECT tbldctos.idLocal,                                               "                                       
	                ...
	                + "                        tmpDET.IDTIPO                                                      "           
				  , nativeQuery = true)		    
		  List<TblDctosOrdenesDTO> listaUnClienteProductoUltimaFactura(int idLocal, List<String> idClientes, List<Integer> idPeriodos);
...
//		  List<TblDctosOrdenesDTO> listaUnClienteProducto(int idLocal, List<String> idClientes, Double xIdPeriodo);
	...
	/*	  @Query( value = " SELECT tmpPRC.idLocal,                             "
		  ...
		  @Query( value = "       SELECT tmpPRC.idLocal,                                                        "
		            ...
		            + "            tmpPRC.idCliente,                                                        "
		            + "            MAX(tmpPRC.nombreTercero) AS nombreTercero,                              "
		            + "            MAX(tbldctosordenes.historiaConsumo)   AS historiaConsumo,               "
		            + "            MAX(tbldctosordenes.promedio) AS promedio,                               "
		            + "            ISNULL(MAX(tblterceros.ordenRuta),0)   AS ordenRuta,                     "
		            + "     	    MAX(tmpPRC.idRuta)  AS idRuta,                                          "
		            + "            MAX(tmpPRC.nombreCiclo) + '-' +                                          "
		            + "            MAX(tmpPRC.nombreRuta) AS nombreRuta,                                    "
		            + "            MAX(tmpPRC.idEstracto) AS idEstracto,                                    "
		            ...
		            + "            MAX(tmpPRC.lecturaMedidor) AS lecturaActual,                             "
		            + "            ISNULL((SELECT TOP 1                                                     "
		            + "            tbldctosordenesdetalle.lecturaAnterior AS lecturaAnterior                "
		            + "             FROM tbldctosordenes                                                    "
		            + "             INNER JOIN tbldctosordenesdetalle                                       "
		            ...
		            + "             WHERE tbldctosordenes.idLocal =  tmpPRC.IDLOCAL                         "
		            ...
		            + "             SUM(tmpPRC.cantidad) AS cantidad,                                       "
		            + "             MAX(tmpFRA.nombreCausa) AS nombreCausa,                                 "
					+ "			 MAX(tmpMedidor.estadoMedidor) AS estadoCorte,                            "
					+ "			 MAX(tmpSuscriptor.estadoSuscriptor) AS estadoSuscriptor                    "
		            + "     FROM (                                                                          "
		            + "     SELECT tbldctos.idLocal,                                                        "
		            + "            tbldctos.idTipoOrden,                                                    "
		            + "            tbldctos.idOrden,                                                        "
		            ...
		            + "     AND tbldctos.IDORDEN = tbldctosordenes.IDORDEN                                  "
		            + "     INNER JOIN tblterceroestracto                                                   "
		            + "     ON tblterceroestracto.idEstracto =  tbldctosordenesdetalle.idEstracto           "
		            + "     AND tblterceroestracto.idLocal =    tbldctosordenesdetalle.idLocal              "
		            + "     INNER JOIN tbltercerosruta                                                      "
		            + "     ON tbldctosordenesdetalle.idRuta   = tbltercerosruta.idRuta                     "
		            + "     AND tbldctosordenesdetalle.idLocal   = tbltercerosruta.idLocal                  "
		            + "     INNER JOIN tblplus                                                              "
		            + "     ON tbldctosordenesdetalle.IDPLU = tblplus.idPlu                                 "
		            ...
		            + "             tbldctosordenes.IDTIPOORDEN,                                            "
		            + "             tbldctosordenes.IDORDEN,                                                "
		            + "             tbltipocausanota.nombreCausa AS estadoMedidor                           "
		            + "     FROM tbldctosordenes                                                            "
		            + "     INNER JOIN tbltipocausanota                                                     "
		            + "     ON tbltipocausanota.idCausa =  tbldctosordenes.estadoCorte                      "
		            + "     WHERE tbldctosordenes.IDLOCAL  = ?2                                             "
		            + "     AND tbldctosordenes.IDTIPOORDEN = ?3                                            "
		            + "     AND tbldctosordenes.IDPERIODO   =  ?4                                           "
		            + "     AND tbltipocausanota.idTipoTabla = 5) AS tmpMedidor                             "
		            + "     ON tmpMedidor.IDLOCAL=tmpPRC.IDLOCAL                                            "
		            + "     AND tmpMedidor.IDTIPOORDEN = tmpPRC.idTipoOrden                                 "
		            + "     AND tmpMedidor.IDORDEN = tmpPRC.idOrden                                         "
					+ "	 INNER JOIN                                                                         "
		            + "     (SELECT tbldctosordenes.IDLOCAL,                                                "
		            + "             tbldctosordenes.IDTIPOORDEN,                                            "
		            + "             tbldctosordenes.IDORDEN,                                                "
		            + "             tbltipocausanota.nombreCausa AS estadoSuscriptor                        "
		            + "     FROM tbldctosordenes                                                            "
		            + "     INNER JOIN tbltipocausanota                                                     "
		            ...
		            + "     AND tbldctosordenes.IDTIPOORDEN = ?3                                            "
		            + "     AND tbldctosordenes.IDPERIODO   =  ?4                                           "
		            + "     AND tbltipocausanota.idTipoTabla = 3) AS tmpSuscriptor                          "
		            + "     ON tmpSuscriptor.IDLOCAL=tmpPRC.IDLOCAL                                         "
		            + "     AND tmpSuscriptor.IDTIPOORDEN = tmpPRC.idTipoOrden                              "
		            + "     AND tmpSuscriptor.IDORDEN = tmpPRC.idOrden                                      "
		            + "     INNER JOIN tblmedidores                                                         "
		            + "     ON tblmedidores.idLocal = tblterceros.IDLOCAL                                   "
		            + "     AND tblmedidores.idMedidor = tblterceros.idMedidor                              "
		            + "     WHERE     tmpPRC.idLocal         =   ?2                                         "
		            + "     AND       tmpPRC.idTipoOrden     =    ?3                                        "
		            + "     AND       tmpPRC.idPeriodo       =  ?4                                          "
		            + "     GROUP BY tmpPRC.idLocal,                                                        "
		            + "            tmpPRC.idTipoOrden,                                                      "
		            + "            tmpPRC.idOrden,                                                          "
		            + "            tmpPRC.idDcto,                                                           "
		  ...
		  @Query( value = " SELECT   tblDctosOrdenes.idLocal,            "
	                ...
	                + "   AND tblDctosOrdenes.idTipoOrden    =     "
	                + "?2                         "
	                + "   AND tblDctos.fechaDcto    BETWEEN ?3 AND ?4   "	                
	                + "   AND tblTerceros.idTipoTercero      =   3 "
	                + "   GROUP BY tblDctosOrdenes.idLocal,        "
	                + "          tblDctosOrdenes.idTipoOrden,      "
	                + " 		 tblDctosOrdenes.idOrden,      "
		  ...
		  @Query( value = " SELECT   tblDctosOrdenes.idLocal,            "
	                ...
	                + " ORDER BY 16 ",
	                nativeQuery = true)
		  List<TblDctosOrdenesDTO> listaPagoNEAll_OK_EntreFechas(int idLocal, int idtipoOrden, String FechaInicial, String FechaFinal);
		  ...
		  @Query( value = "SELECT        tblDctosOrdenesDetalle.IDLOCAL,						  "
					...
					+ "		  MAX(ctrlUsuarios.nombreUsuario) AS nombreUsuario,               "
					+ "		  MAX(tblTercerosRuta.nombreRuta) AS nombreRuta               	"
				  + "FROM          tblDctosOrdenes                                            "
				  + "INNER JOIN  tblDctosOrdenesDetalle                                       "
				  + "ON tblDctosOrdenes.IDLOCAL = tblDctosOrdenesDetalle.IDLOCAL              "
				  + "AND tblDctosOrdenes.IDTIPOORDEN = tblDctosOrdenesDetalle.IDTIPOORDEN     "
		  ...
		  @Query( value = "SELECT        tblDctosOrdenesDetalle.IDLOCAL,						  "
				  ...
				  + "ORDER BY MAX(tblDctosOrdenesDetalle.fechaRegistroTx) 					"	,
                nativeQuery = true)
         List<TblDctosOrdenesDTO> listaLecturaAppxUsuario(int idLocal, int idTipoOrden ,int idPeriodo, int idUsuario);
		  ...
		  @Query( value = "SELECT        tblDctosOrdenesDetalle.IDLOCAL,						  "
				  ...
				  + "AND   tblDctosOrdenes.IDTIPOORDEN = ?2                                   "
				  + "AND   tblDctosOrdenes.IDPERIODO = ?3                                 	"
				  + "AND  tblDctosOrdenesDetalle.fechaRegistroTx IS NULL 					"		
				  + "AND   tblTerceros.idTipoTercero = 1                                      "
				  + " AND   tblDctosOrdenesDetalle.IDTIPO = 4   							"
				  + "GROUP BY tblDctosOrdenesDetalle.IDLOCAL,								"
				  + "              tblDctosOrdenesDetalle.IDTIPOORDEN,    					"
				  ...
				  + "ORDER BY MAX(tblDctosOrdenesDetalle.fechaRegistroTx) 					"	,
                nativeQuery = true)
         List<TblDctosOrdenesDTO> listaLecturaAppSinExportar(int idLocal, int idTipoOrden ,int idPeriodo);
		  ...
		  @Query( value = "SELECT        tblDctosOrdenesDetalle.IDLOCAL,						  "
				  ...
				  + "ORDER BY MAX(tblDctosOrdenesDetalle.fechaRegistroTx) 					"	,
              nativeQuery = true)
       List<TblDctosOrdenesDTO> listaLecturaAppSinExportarxUsuario(int idLocal, int idTipoOrden ,int idPeriodo, int idUsuario);
		  
		  
		  
		  @Query( value = "     SELECT tmpTOT.IDLOCAL, tmpTOT.idUsuario, tmpTOT.nombreUsuario, tmpTOT.nombreRuta, 'No visitados' AS tipo,COUNT(*) AS CUENTA     "
					+ "		  FROM (                                                                                                     "
					+ "		                                                                                                             "
					+ "		  SELECT        tblDctosOrdenesDetalle.IDLOCAL,						                                         "
					+ "		              tblDctosOrdenesDetalle.IDTIPOORDEN,                                                            "
					...
					+ "		  			  tblDctosOrdenesDetalle.IDORDEN,            				                                     "
					+ "		  			  tblDctosOrdenesDetalle.idCliente,                                                              "
					+ "					  tblTercerosRuta.nombreRuta) AS tmpTOT 	                                                     "
					+ "		 GROUP BY tmpTOT.IDLOCAL, tmpTOT.idUsuario, tmpTOT.nombreUsuario, tmpTOT.nombreRuta                                                "
					+ "		 UNION                                                                                                       "
			        + "          SELECT tmpTOT.IDLOCAL, tmpTOT.idUsuario, tmpTOT.nombreUsuario, tmpTOT.nombreRuta, 'Visitados' AS tipo,COUNT(*) AS CUENTA       "
					+ "		  FROM (                                                                                                     "
					+ "		                                                                                                             "
					+ "		  SELECT        tblDctosOrdenesDetalle.IDLOCAL,						                                         "
					+ "		              tblDctosOrdenesDetalle.IDTIPOORDEN,                                                            "
					...
					+ "		 GROUP BY tmpTOT.IDLOCAL, tmpTOT.idUsuario, tmpTOT.nombreUsuario, tmpTOT.nombreRuta					                             ",
              nativeQuery = true)
       List<TblDctosOrdenesDTO> listaLecturaResumenApp(int idLocal, int idTipoOrden ,int idPeriodo);
		  ...
		  @Query( value = "     SELECT tmpTOT.IDLOCAL, tmpTOT.idUsuario, tmpTOT.nombreUsuario, tmpTOT.nombreRuta, 'No visitados' AS tipo,COUNT(*) AS CUENTA     "
					...
					+ "		 GROUP BY tmpTOT.IDLOCAL, tmpTOT.idUsuario, tmpTOT.nombreUsuario, tmpTOT.nombreRuta					                             ",
            nativeQuery = true)
     List<TblDctosOrdenesDTO> listaLecturaResumenAppxUsuario(int idLocal, int idTipoOrden ,int idPeriodo, int idUsuario);
