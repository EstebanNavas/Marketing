...
public interface TblDctosOrdenesDetalleRepo extends JpaRepository<TblDctosOrdenesDetalle, Integer> {
	...
	// Eliminamos los registros del IDORDEN de ese momento
		  ...
		  public void actualizarEstadoDetalleFinal(int idLocal, int IDORDEN, String idCliente);
			...
			String ObtenerNombrePlu(int idLocal, int IDORDEN, String idCliente, int idCategoria);
			  ...
			  @Query(value = "SELECT tbldctos.idLocal,                    "
		                ...
		                + "       tbldctosordenesdetalle.idPlu,        "
		                + "      SUM(tbldctosordenesdetalle.cantidad * "
		                + "                vrVentaUnitario) AS vrVentaConIva, "
			  ...
			  @Query(value = "DELETE FROM tblDctosOrdenesDetalle            "  
					  ...
					  + "   tblDctosOrdenesDetalle.idCliente,        "
					  + "   COUNT(*) AS cuenta,                      "
					  + "   MAX(tblTerceros.idTipoTercero) AS idTipoTercero,"
					  ...
					  + "                           tmpDOB.maxItem  "
					  +" 	AND tmpDOB.idTipoTercero = 1			", nativeQuery = true)
			  ...
			  @Query(value = "    UPDATE tblDctosOrdenesDetalle                                                       "
						...
						+ "	    (SELECT TOP (1) tmpDET.lecturaMedidor                                              "
						+ "	     FROM tblDctos AS tmpDCT                                                           "
						+ "	     INNER JOIN tblDctosOrdenesDetalle  AS tmpDET                                      "
						+ "	     ON tmpDCT.IDLOCAL =  tmpDET.IDLOCAL                                               "
						+ "	     AND tmpDCT.IDTIPOORDEN = tmpDET.IDTIPOORDEN                                       "
						+ "	     AND tmpDCT.IDORDEN  =  tmpDET.IDORDEN                                             "
						+ "	     AND tmpDCT.IDLOCAL  = ?1                                                         "
						+ "	     AND tmpDCT.IDTIPOORDEN IN (9, 29)                                                 "
						+ "	     AND tmpDCT.idPeriodo   = ?2                                                   "
						+ "	     AND tmpDET.IDTIPO      = 4                                                        "
						+ "	     AND tmpDET.idCliente   =                                                          "
						+ "	         tblDctosOrdenesDetalle_1.idCliente                                            "
						+ "	     ORDER BY tmpDCT.idCliente,                                                        "
						...
						+ "	    INNER JOIN tblDctosOrdenes                                                         "
						+ "	    ON tblDctosOrdenes.IDLOCAL =  tblDctosOrdenesDetalle_1.IDLOCAL                     "
						+ "	    AND tblDctosOrdenes.IDTIPOORDEN = tblDctosOrdenesDetalle_1.IDTIPOORDEN             "
						+ "	    AND tblDctosOrdenes.IDORDEN  =  tblDctosOrdenesDetalle_1.IDORDEN                   "
						+ "		-- CORE                                                                            "
						+ "		INNER JOIN  tblTerceros                                                            "
		                + "        ON tblDctosOrdenesDetalle_1.idLocal = tblTerceros.idLocal                       "
		                + "        AND tblDctosOrdenesDetalle_1.idCliente = tblTerceros.idCliente                  "
						+ "		INNER JOIN  tblTercerosRuta                                                        "
		                + "        ON tblTerceros.idLocal = tblTercerosRuta.idLocal                                "
		                + "        AND tblTerceros.idRuta = tblTercerosRuta.idRuta						           "
						+ "	    WHERE tblDctosOrdenes.IDLOCAL  =  ?1                                              "
						+ "	    AND  tblDctosOrdenes.IDTIPOORDEN   = 59                                            "
						+ "	    AND  tblDctosOrdenesDetalle_1.IDTIPO = 4                                           "
						+ "	    AND  tblDctosOrdenes.idPeriodo =  ?3                                           "
						+ "		AND   tblTercerosRuta.idCiclo = ?4                                                  "
						+ "		AND   tblTerceros.idTipoTercero = 1)                                               "
						+ "		                               AS tmpCON                                           "
						+ "	    ON  tmpCMO.IDLOCAL = tmpCON.IDLOCAL                                                "
						+ "	    AND tmpCMO.IDTIPOORDEN = tmpCON.IDTIPOORDEN                                        "
						+ "	    AND tmpCMO.idCliente   =  tmpCON.idCliente                                         "
						+ "	    WHERE  tmpCMO.IDLOCAL =  ?1                                                       "
						+ "	    AND tmpCMO.IDTIPOORDEN = 59                                                        "
						+ "	    AND  tmpCMO.IDTIPO     = 4 ) AS tmpCFI                                             "
						+ "		                                                                                   "
						+ "	    ON tblDctosOrdenesDetalle.IDLOCAL      = tmpCFI.IDLOCAL                            "
						+ "	    AND tblDctosOrdenesDetalle.IDTIPOORDEN = tmpCFI.IDTIPOORDEN                        "
						+ "	    AND tblDctosOrdenesDetalle.idCliente   =  tmpCFI.idCliente                         "
						+ "	    WHERE tblDctosOrdenesDetalle.IDTIPO    = 4                                         "
		                , nativeQuery = true)
			  public void cantidadM3_ciclo(int idLocal, int IdPeriodoAnterior, int idPeriodo, int idCiclo );
	  ...
	  @Query(value = " INSERT INTO tbldctosordenesdetalle "
                ...
                + "                                                                 "
                + "		      CASE                                                  "
                + "        WHEN SUM(tbldctosordenesdetalle.cantidad)> 60 THEN 20    "
                + "		ELSE SUM(tbldctosordenesdetalle.cantidad) - 40              "
                + "		END AS cantidad,                                            "
                + "                                                                 "
                + "		  MAX(tmpPLU.idTipo) AS idTipo, 		                    "
                + "		  MAX(tmpPLU.porcentajeIva) AS porcentajeIva,               "        
                + "		  (MAX(tmpPLU.vrGeneral) *                                  "
                + "		?4)  AS vrVentaUnitario,                                    "
                + "		  0 AS estado,                                              "
                ...
                + "		  ,SUM(tbldctosordenesdetalle.cantidad)                     "
                + "		                       AS CANTIDADPEDIDA                    "
                + "		  ,MAX(tmpPLU.rangoMaximo) AS strIdLista                    "
                + "		  ,MAX(tmpPLU.rangoMaximo) AS item,                         "
                + "		  1 AS itemPadre,        	                                "
                + "		  0 AS idEstadoTx,                                          "
                + "		  0 AS idTipoTx,                                            "
                + "		  0 AS lecturaMedidor,                                      "
                + "		  tbldctosordenesdetalle.idCliente,                         "
                + "		  MAX(tbldctosordenesdetalle.idEstracto) AS idEstracto,     "     
                ...
                + "		           tbldctosordenesdetalle.idCliente                 "
                + "		 HAVING SUM(tbldctosordenesdetalle.cantidad) > ?7           ",
                nativeQuery = true)
	  public void ingresaMultaMayor40(int idLocal, int IdTipoOrden, int IdOrden, int xIdSigno, int xIdTipoMulta, int idPeriodo, int xMultaSupera40, int xMultaSupera60 );
	  ...
	  @Query(value = " INSERT INTO tbldctosordenesdetalle "
                ...
                + "		?3  AS idOrden,	                                        	"
                + "		  tmpPLU.idPlu, 		                                    "
                + "  SUM(tbldctosordenesdetalle.cantidad) - 60 AS cantidad,         "
                + "		  MAX(tmpPLU.idTipo) AS idTipo, 		                    "
                + "		  MAX(tmpPLU.porcentajeIva) AS porcentajeIva,               "        
                + "		  (MAX(tmpPLU.vrGeneral) *                                  "
                + "		?4)  AS vrVentaUnitario,                                    "
                ...
                + "		 HAVING SUM(tbldctosordenesdetalle.cantidad) > ?7           ",
                nativeQuery = true)
	  public void ingresaMultaMayor60(int idLocal, int IdTipoOrden, int IdOrden, int xIdSigno, int xIdTipoMulta, int idPeriodo, int xMultaSupera40, int xMultaSupera60 );
		...
		+ "   ,tblPagos.nitcc ",
			  ...
			  @Query(value = "    INSERT INTO tbldctosordenesdetalle                                "           
			            ...
			            + "           ,tbldctosordenesdetalle.IDORDEN                            "
						+ "		   ,CASE                                                         "                   
	                    + "            WHEN ROUND((ROUND(SUM(tbldctosordenesdetalle.cantidad *   "
			            + "            tbldctosordenesdetalle.VRVENTAUNITARIO)/100,0)*100)       "
			            + "            - SUM(tbldctosordenesdetalle.cantidad *                   "
			            + "            tbldctosordenesdetalle.VRVENTAUNITARIO),2) > 0.0          "                                              
	                    + "           THEN (SELECT TOP 1 idPlu                                   "
	                    + "                FROM [bdaquamovil].[dbo].[tblPlus]                    "
	                    + "                WHERE IDLOCAL = ?1                                    "
	                    + "                AND   idLinea =   1                                   "
	                    + "                AND  idTipo   =  ?2                                   "
						+ "				AND idCategoria = 7)                                     "                                   
	                    + "           ELSE (SELECT TOP 1 idPlu                                   "
	                    + "                FROM [bdaquamovil].[dbo].[tblPlus]                    "
	                    + "                WHERE IDLOCAL = ?1                                    "
	                    + "                AND   idLinea =   1                                   "
	                    + "                AND  idTipo   =  ?2                                   "
			            ...
			            + "            - SUM(tbldctosordenesdetalle.cantidad *                   "
			            + "            tbldctosordenesdetalle.VRVENTAUNITARIO),2) > 0.0          "                                              
	                    + "           THEN (SELECT TOP 1 nombrePlu                               "
	                    + "                FROM [bdaquamovil].[dbo].[tblPlus]                    "
	                    + "                WHERE IDLOCAL = ?1                                    "
	                    + "                AND   idLinea =   1                                   "
	                    + "                AND  idTipo   =  ?2                                   "
						+ "				AND idCategoria = 7)                                     "                                   
	                    + "           ELSE (SELECT TOP 1 nombrePlu                               "
	                    + "                FROM [bdaquamovil].[dbo].[tblPlus]                    "
	                    + "                WHERE IDLOCAL = ?1                                    "
	                    + "                AND   idLinea =   1                                   "
	                    + "                AND  idTipo   =  ?2                                   "
						...
						+ "	 AND tmpAJU.idCategoria =                                            "
						+ "		 CASE                                                            "
	                    + "           WHEN VRVENTAUNITARIO > 0                                   "
	                    + "         THEN 7                                                       "
	                    + "         ELSE 37                                                      "
	                    + "         END                                                          "
			            ...
			            + "           ,tbldctosordenesdetalle.idOrden                            ",
		                nativeQuery = true)
			  public void ingresaTipoCentenaXCategoria(int idLocal, int IdTipo, int IdTipoOrden, int idPeriodo );
			  ...
			  @Query(value = " SELECT   tbldctosordenesdetalle.idPlu,                           "                      
			            ...
			            + "          tbldctosordenesdetalle.idPlu                            ",
		                nativeQuery = true)
			  List<TblDctosOrdenesDetalleDTO2> detalleInventarioOrdenDeTrabajo(int idLocal, int IdTipoOrden, int IdOrden);
			  ...
			  @Query(value = " INSERT INTO tbldctosordenesdetalle       "
		                ...
		                + "	     tblplus.vrGeneral,                 	"
		                + "	RTRIM(tblcategorias.nombreCategoria) + ' ' + "
		                + "	       RTRIM(tblplus.nombrePlu) AS nombrePlu, "
		                + "	     tblplus.idEstracto,                "
		                + "          tblplus.topeMaximo                 "
		                + " FROM tblcategorias                          "
		                + " INNER JOIN tblplus                          "
			  ...
			  @Query(value = " SELECT tblDctosOrdenesDetalle.idLocal,     "
					  ...
					  + " AND tblDctosOrdenes.idOrden    =      ?3   ",
		                nativeQuery = true)
			  List<TblDctosOrdenesDetalleDTO2> listaContratoNE(int idLocal, int idTipoOrden, int idOrden);
			  ...
			  @Query(value = "INSERT INTO tblDctosOrdenesDetalle             "
		                ...
		                + "    ,0 AS PORCENTAJEDSCTO                    "
		                + "    ,0 AS CANTIDADPEDIDA                     "
		                + "    ,0 AS vrCostoNegociado                   "
		                + "    ,1 AS strIdBodega                        "
		                + "    ,0 AS vrCostoResurtido                   "
		                + "    ,0 AS STRIDLISTA                         "
		                + "    ,0 AS STRIDREFERENCIA                    "
		                + "    ,0 AS PESOTEORICO                        "
		                + "    ,0 AS NOMBREUNIDADMEDIDA                 "
		                + "    ,tblPlus.idLocal AS IDLOCALSUGERIDO      "
		                + "    ,1 AS IDBODEGASUGERIDO                   "
		                + "    ,'' AS comentario                        "
		                + "    ,0 AS item                               "
		                + "    ,0 AS itemPadre                          "
		                + "    ,0 AS idEstadoTx                         "
		                + "    ,0 AS idTipoTx                           "
		                + "    ,0 AS idReferenciaOriginal               "
		                ...
		                + "  WHERE tblPlus.idLocal         =            "
		                + "?1                              "
		                + "  AND tblPlus.idLinea         = 100  ", 
		                nativeQuery = true)
			  public void ingresaNE(int idLocal, int IdTipoOrden, int idOrden);
			  ...
			  @Query(value = " DELETE                                "
		                ...
		                + " AND  tblPlus.idCategoria            "
		                + "                 NOT IN (1400, 1800) "
		                + " AND tblPlus.idPlu   NOT IN ( ?4 )  ", 
		                nativeQuery = true)
			  public void retiraPluNE(int idLocal, int IdTipoOrden, String idCliente, List<Integer> xIdPluInNE);
			  ...
			  @Query(value = " UPDATE tblDctosOrdenesDetalle         "
		                ...
		                + " AND  tblDctosOrdenes.IDORDEN    =   "
		                + "?3                      "
		                + " AND  tblPlus.idPluNE =       ?4     ", 
		                nativeQuery = true)
			  public void actualizaPluBasicoNE(int idLocal, int IdTipoOrden, int idOrden, int idPlu);
			  ...
			  @Query(value = " UPDATE tblDctosOrdenesDetalle         "
		                ...
		                + " AND tblPlus.idPluNE             =  ?4 ", 
		                nativeQuery = true)
			  public void actualizaPluTransporteNE(int idLocal, int IdTipoOrden, int idOrden, int idPlu);
			  ...
			  @Query(value = " DELETE                                "
		                ...
		                + " AND tblPlus.idLinea = 100 ", 
		                nativeQuery = true)
			  public void retiraPluContratoNE(int idLocal, int IdTipoOrden, int idOrden);
			  ...
			  @Query(value = "  SELECT tbldctos.idLocal,                                                            "
					  + "  tbldctos.idCliente,                                                                      "
					  + "  tblciudades.idDpto AS idDpto,                                                            "
					  + "  tblTerceros.codigoCatastral AS codigoCatastral,                                          "
					  + "  tblciudades.idCiudad,                                                                    "
					  + "  tblTercerosSui.idIgacSector,                                                             "
					  + "  tblTercerosSui.corregimiento,                                                            "
					  + "  tblTercerosSui.barrio,                                                                   "
					  + "  tblTercerosSui.idIgacVereda,                                                             "
					  ...
					  + "  tbltercerossui.idHogarComunitario,                                                       "
					  + "  tbltercerossui.estadoMedidor,                                                            "
					  + "  tblTercerosSui.idTipoLectura AS DeterminacionConsumo,                                    "
					  ...
					  + "  tblTercerosSui.vrCostoMediaTasaUso AS CMT,                                               "
					  ...
					  + "  tbltercerossui.idCausaRefactura,                                                         "
					  + "  tbltercerossui.dctoRefactura,                                                            "
					  + "  0  AS vrPagoAnticipado,                                                                  "
					  + "  tmpLEC.nombreCausa,                                                                      "
					 ...
					 + "	WHERE tblpagos.IDLOCAL = tbldctos.idLocal                                                  "
					 + "	AND tblpagos.IDTIPOORDEN = tbldctos.idTipoOrden                                            "
					 + "	AND tblpagos.nitCC  = tbldctos.idCliente                                                   "
					 + "	AND tblpagos.idPeriodo = ?2                                                            "
					 + "	 AND tblPlus.idTipo NOT IN (50,51,150,151,25,29,125,129)) AS vrPago                        "
					  + "  FROM tbldctos                                                                            "
					  + "  INNER JOIN                                                                               "
					  + "  (SELECT tbldctosordenesdetalle.idLocal,                                                  "
					 ...
					 + "	   ,tblPlus.vrCostoIND                                                                     "
					  ...
					  + "        tbldctosordenesdetalle.IDTIPOORDEN,                                                "
					  + " 	  tbldctosordenesdetalle.idCliente,                                                    "
					  + "        MAX(ISNULL(tbldctosordenesdetalle.lecturaAnterior,0))                              "
					  + " 	                                 AS lecturaAnterior                                    "
					  + " FROM tbldctosordenesdetalle                                                               "
					  + " INNER JOIN tbldctos                                                                       "
					  + " ON tbldctosordenesdetalle.IDLOCAL = tbldctos.IDLOCAL                                      "
					  ...
					  + "          tbldctos.idPeriodo,                                                              "
					  + "          tbldctosordenesdetalle.idcliente,                                                "
					  + " 	    SUM(ISNULL(tbldctosordenesdetalle.CANTIDAD,0))                                     "
					  + " 	                                     AS consumo                                        "
					  + " FROM tbldctos                                                                             "
					  + " INNER JOIN tbldctosordenesdetalle                                                         "
					  + " ON tbldctos.idLocal = tbldctosordenesdetalle.IDLOCAL                                      "
					  ...
					  + " ON tbldctos.idLocal = tblTercerosSui.idLocal                                              "
					  + " AND tbldctos.idCliente = tblTercerosSui.idCliente                                         "
			  ...
			  @Query(value = "  SELECT tbldctos.idLocal,                                                            "
					 ...
					 + "	 tbldctosordenesdetalle.STRIDLISTA                                                         "
					  ...
					  + "   AND tbldctos.idPeriodo = ?2                                                         "
					  + "   AND tbldctos.idTipoOrden IN (9,29)                                                      "
					  + "  	AND tbldctosordenesdetalle.idRuta = ?4																	"
					  + "   AND tbldctosordenesdetalle.VRVENTAUNITARIO!=0                                           "
					  + "   AND tbldctosordenesdetalle.CANTIDAD != 0) AS tmpDET                                     "
					  + "  ON tbldctos.IDLOCAL = tmpDET.IDLOCAL                                                     "
					  + "  AND tbldctos.IDTIPOORDEN = tmpDET.IDTIPOORDEN                                            "
					 ...
					 + "	   ,tblPlus.vrCostoIND                                                                     "
					  ...
					  + "           tmpDET.IDTIPO DESC                                                              ",
		                nativeQuery = true)
			  List<TblDctosOrdenesDetalleDTO3> ReporteSuiAntProductoxRuta(int idLocal, int idPeriodo, int idProducto, int idRuta);
			  ...
			  @Query(value = " UPDATE   tblDctosOrdenesDetalle          "
		                ...
		                + " AND  tblDctosOrdenesDetalle.IDORDEN =    "
		                + "?5                           "
		                + " AND  tblDctosOrdenesDetalle.IDPLU =  ?6    ", 
		                nativeQuery = true)
			  public void actualizaNE(Double VrVentaUnitario, int Cantidad, int idLocal, int idtipoOrden, int idOrden, int idPlu);
			  ...
			  @Query(value = " INSERT INTO tblDctosOrdenesDetalle      "
		                ...
		                + "   AND   tblDctosOrdenes.idTipoOrden=  "
		                + "?4                    "
		                + "   AND   tblDctosOrdenes.idOrden    = ?5  ", 
		                nativeQuery = true)
			  public void ingresaPagoNE(int xIdTipoOrdenTmp, int xIdOrdenTmp, int idLocal, int idtipoOrden, int idOrden);
			  ...
			  @Query(value = "INSERT INTO tbldctosordenesdetalle (idLocal, "
		                ...
		                + "?26,"
		                + "?27)", nativeQuery = true)
			  public void ingresaDetalle(int idLocal, int IdTipoOrden, int IdOrden, int cantidad, String nombrePlu, int idPlu, int idTipo, int estado, int porcentajeIva, Double vrVentaUnitario, 
			  ...
			  @Query(value = "    SELECT tbldctos.idLocal,                            "                         
						...
						+ "     MAX(tmpTER.CC_Nit) AS CC_Nit,                      "          
						+ "	 MAX(tbldctosordenesdetalle.CANTIDAD) AS cantidad,     " 
						+ "  CONVERT(date, MAX(tbldctos.fechaDcto)) AS fechaDcto   "
						+ "    FROM tbldctosordenesdetalle                         "          
						+ "    INNER JOIN tbldctos                                 "          
						+ "    ON [tbldctos].idLocal     =                         "          
						+ "     tbldctosordenesdetalle.IDLOCAL                     "          
						...
						+ "             tbldctos.idDcto,                           "          
						+ "    	 tmpCAT.idProducto                                 ", nativeQuery = true)
			  List<TblDctosOrdenesDetalleDTO> listaInventarioMovimientoPeriodo(int idLocal, int IdTipoOrden, int idPeriodo);
			  ...
			  @Query(value = " SELECT tbldctos.idLocal,                                               "          
						...
						+ "	 MAX(tbldctosordenesdetalle.CANTIDAD) AS cantidad,                     "          
						+ "	 CONVERT(date, MAX(tbldctos.fechaDcto)) AS fechaDcto,                  "          
						+ "	 MAX(tblTipoOrden.nombreTipoOrden) AS nombreTipoOrden,                 "          
						+ "	 MAX(tblTipoOrden.signo) AS signo                                      "          
						+ "    FROM tbldctosordenesdetalle                                         "          
						+ "    INNER JOIN tbldctos                                                 "          
						+ "    ON [tbldctos].idLocal     =                                         "          
						+ "     tbldctosordenesdetalle.IDLOCAL                                     "          
						...
						+ "	ON tblDctos.IDTIPOORDEN = tblTipoOrden.idTipoOrden                     "          
		                + "                                                                        "          
						+ "    WHERE tbldctos.idLocal            =                                 "          
						+ "  ?1                                                                    "          
						+ "  AND tmpCAT.idPlu  = ?2                                                "          
						+ "  AND tbldctos.idOrden >= ?3                                         "          
					/*	+ "    AND (tbldctosordenesdetalle.cantidad *                              "          
						+ "               vrVentaUnitario) != 0                                    "    */      
						+ "    GROUP BY tbldctos.IDdcto,                                           "   
						+ "             tbldctos.idOrden,                                          "
					...
					/*	+ "   HAVING SUM(tbldctosordenesdetalle.cantidad *                         "          
						...
						+ "    ORDER BY 12 , 4 asc                                                 ", 
						nativeQuery = true)
			  List<TblDctosOrdenesDetalleDTO> listaInventarioMovimientoKardex(int idLocal, int idPlu, int idOrden);
			  ...
			  @Query(value = "    SELECT tbldctos.idLocal,                            "                         
						...
						+ "  ?1                                                   "          
						+ "  AND tbldctos.idTipoOrden  = ?2                        " 
						+ " AND   CONVERT(VARCHAR(10), tbldctos.fechaDcto, 23)     "
						+ " BETWEEN ?3 AND  ?4                                     "
						+ "    AND (tbldctosordenesdetalle.cantidad *              "          
						+ "               vrVentaUnitario) != 0                    "          
						+ "    GROUP BY tbldctos.IDdcto,                           "          
						...
						+ "             tbldctos.idDcto,                           "          
						+ "    	 tmpCAT.idProducto                                 ", nativeQuery = true)
			  List<TblDctosOrdenesDetalleDTO> listaInventarioMovimientoFecha(int idLocal, int IdTipoOrden, String fechaInicio, String fechaFin);
			  ...
			  @Query(value = "SELECT * " +
		                 ...
		                 "AND tblDctosOrdenesDetalle.idCliente = ?3 " +
		                 //"AND tblDctosOrdenesDetalle.IDTIPO = 4 " +
		                 "AND tblDctosOrdenesDetalle.IDTIPOORDEN IN (9,59) "
		                 , nativeQuery = true)
