	  ...
	  @Query(
		...
		// Actualizamos Suscriptor
		  ...
		  public void actualizarTercero(String nombreTercero,  String direccionTercero, String direccionCobro, int idDptoCiudad, String telefonoFijo,
					...
					String codigoCatastral, java.sql.Timestamp fechaIngreso, java.sql.Timestamp fechaDeInstalacion, String codigoAlterno, int tipoSuscriptor, String matricula, int estadoSuscriptorInt, int estadoCorteInt, Double promedio, int estadoEmail, int estadoWhatsApp, String tipoIdTercero,  int idLocal, String idCliente, int idTipoTercero) ;
		  ...
		  public void actualizarTerceroCliente(String nombreTercero,  String direccionTercero, String direccionCobro, int idDptoCiudad, String telefonoFijo,
			...
			// Actualizamos Suscriptor
			  ...
			  @Query(value = " UPDATE tblterceros                                    " +
					  " SET  historiaConsumo =                                       " +
					  "       tbldctosordenesdetalle_2.historicoConsumo              " +
					  " FROM     tblterceros                                         " +
					  " INNER JOIN                                                   " +
					  ...
					  " ?1   ) AS tbldctosordenesdetalle_2                           " +
					  " ON tblterceros.IDLOCAL =                                     " +
					  "                   tbldctosordenesdetalle_2.IDLOCAL           " +
					  " AND tblterceros.idCliente =                                  " +
					  "                tbldctosordenesdetalle_2.idCliente "  , nativeQuery = true)
			  ...
			  public void actualizaRecuperaEstadoCorte(int idLocal, int xIdPeriodo);
				...
				@Query(value = " SELECT tblterceros.idLocal        "
		                ...
		                + "          tblterceros.ordenRuta ",
						nativeQuery = true)
				List<TercerosDTO> listaTodosLosClientesEstadoFacturaActRUTA(int idLocal, int idPeriodo, int idRuta);
		...
		+ " 		    AS lecturaAnterior,            "
				...
				@Query(value = "                  SELECT tblterceros.idCliente,                                         "          
						...
						+ "          		                   AND tbldctosordenesdetalle.IDTIPO =                 "          
						+ "          		                ?3                                                      "          
						+ "          		                   AND tbldctosordenesdetalle.IDORDEN =   ?5         "          
						+ "          		                   AND tbltipocausanota.idTipoTabla  = 2               "          
						+ "          		                   GROUP BY tbldctosordenesdetalle.idCliente)          "          
						+ "          		                                                     AS tmpCAU         "          
						+ "          		                  ON tmpCAU.idCliente = tblterceros.idCliente          "          
						+ "          		                  WHERE tblterceros.idLocal         = ?1              "          
						+ "          						        AND tblterceros.idCliente = ?6           "                              
						+ "          		                  AND tblterceros.estado NOT IN (2)                    ",
						nativeQuery = true)
				List<TercerosDTO2> listaLecturaRutaTxCliente(int idLocal, int xIdPeriodoAnterior, int xIdTipo, int idPeriodo, int idOrden, String idCliente );
		...
		+ " 		    AS lecturaAnterior,            "
				...
				@Query(value = "     SELECT tmpRES.idCliente,                                      "                  
			            + "        tmpRES.nombreTercero, 	                                  "                 
			            + "        tmpRES.estado,                                             "                  
			            + "        tmpRES.idRuta,                                             "                  
			            + "        tmpRES.nombreCiudad,                                       "                  
			            + "        tmpRES.nombreRuta ,                                        "                  
	                    + "                                                                   "                  
			            + "        tmpRES.idEstracto,                                         "                  
			            + "        tmpRES.nombreEstracto,                                     "                  
			            + "        tmpRES.lecturaActual,                                      "                  
			            + "        tmpRES.lecturaAnterior,                                    "                  
						+ " 	   (tmpRES.lecturaActual -                                    "                     
			            + "        tmpRES.lecturaAnterior) AS consumo,                        "                  
						+ " 	   tmpRES.promedio,                                           "                     
						+ " 	   tmpRES.valorExceso,                                        "                     
						+ " 	   tmpRES.ordenRuta,                                          "                     
						+ " 	   tmpRES.idCausa,                                            "                     
			            ...
			            + "                                 AS lecturaActual,                 "                  
	                    + "      ( SELECT  TOP 1                                              "                  
						+ " 		          tmpDET.lecturaMedidor  as lecturaAnterior       "                              
						+ " 		 FROM   tblDctos tmpDCT                                   "                     
						+ " 		 INNER JOIN tblDctosOrdenesDetalle                        "                     
						+ " 		                            tmpDET                        "                     
						...
						+ " 		 AND   tmpDCT.idLocal     =   ?2                          "                               
						+ " 		 AND   tmpDCT.idTipoOrden IN (9,29)                       "                     
						+ " 		 AND   tmpDCT.idPeriodo   =  ?3                           "                       
						+ " 		 AND   tmpDET.IDTIPO      =   ?5                          "                               
						+ " 		 AND   tmpDET.IDCLIENTE   = tblterceros.idCliente         "                             
						+ " 		 ORDER BY tmpDCT.idCliente ,                              "                     
						+ " 		           tmpDCT.idOrden DESC )                          "                     
						+ " 		 		    AS lecturaAnterior,                           "                     
			            + "        tblterceros.promedio,                                      "                  
						...
						+ " 	AND  tbltipocausanota.idTipoTabla = 2                         "                     
						+ " 			   ) AS tmpRES                                        "                     
						+ " 			   Where (ISNULL(tmpRES.lecturaActual,0) -            "          
		                + "        ISNULL(tmpRES.lecturaAnterior,0))>=                        "          
		                + "     (tmpRES.promedio *(1+(                                        "          
		                + "      ?1/100)))                                                    "          
					    + "      AND    tmpRES.promedio  !=0                                  "          
		                + "      AND (ISNULL(tmpRES.lecturaActual,0) -                        "          
		                + "        ISNULL(tmpRES.lecturaAnterior,0)) >                        "          
		                + "      ?7                                                           "                     
						+ " 	ORDER BY tmpRES.idRuta,                                       "                     
						+ " 	           tmpRES.ordenRuta,                                  "                     
						+ " 	           tmpRES.idCliente                                   ",
						nativeQuery = true)
				...
				@Query(value = "SELECT  tblterceros.idCliente,                "
		                ...
		                + "           tblterceros.idCliente",
						nativeQuery = true)
				List<TercerosDTO2> listaCriticaPorcentajeExcesoTodasRutas(Double xPorcentajeExceso, int idLocal, int xIdPeriodoAnterior, int xIdPeriodoActual, int xIdTipo,  Double xConsumoBase);
				...
				@Query(value = "    SELECT tmpRES.idCliente,                                    "          
						...
						+ "	AND  tbltipocausanota.idTipoTabla = 2                          "          
						+ "			   ) AS tmpRES                                         "          
						+ "			   Where (tmpRES.lecturaActual -                       "          
						+ "	   tmpRES.lecturaAnterior)<                                    "          
						+ "	   (tmpRES.promedio *(                                         "          
						+ "	?1/100))                                                      "          
						+ "	  AND    tmpRES.promedio  !=0                                  "          
						+ "	  AND    (tmpRES.lecturaActual -                               "          
						+ "	                 tmpRES.lecturaAnterior) <                     "          
						+ "	?7                                                            "          
						+ "	ORDER BY tmpRES.idRuta,                                        "          
						+ "	           tmpRES.ordenRuta,                                   "          
				...
				@Query(value = "SELECT  tblterceros.idCliente,                "
		               ...
		               ,
						nativeQuery = true)
				List<TercerosDTO2> listaCriticaPorcExcesoDefectoTodasRutas(Double xPorcentajeExceso, int idLocal, int xIdPeriodoAnterior, int xIdPeriodoActual, int xIdTipo, Double xConsumoBase);
				...
				@Query(value = "SELECT  tblterceros.idCliente,                "
		               ...
		               ,
						nativeQuery = true)
				List<TercerosDTO2> listaCriticaConsumoCeroTodasRutas(int idLocal, int xIdPeriodoAnterior, int xIdPeriodoActual, int xIdTipo);
				...
				@Query(value = "     SELECT tmpRES.idCliente,                                         "          
						...
						+ " 									) AS tmpRES                      "          
					    + "        Where(ISNULL(tmpRES.lecturaActual,0) -                        "          
			            + "                      ISNULL(tmpRES.lecturaAnterior,0)) < 0           "          
	                    + "                                                                      "          
			            + "       ORDER BY tmpRES.idRuta,                                        "          
			            + "                tmpRES.ordenRuta,                                     "          
			            + "                tmpRES.idCliente                                      "
				...
				@Query(value = "SELECT  tblterceros.idCliente,                "
		               ...
		               ,
						nativeQuery = true)
				List<TercerosDTO2> listaCriticaConsumoNegativoTodasRutas(int idLocal, int xIdPeriodoAnterior, int xIdPeriodoActual, int xIdTipo);
				...
				@Query(value = "SELECT  tblterceros.idCliente,                "
		               ...
		               ,
						nativeQuery = true)
				List<TercerosDTO2> listaCriticaPromedioCeroTodasRutas(int idLocal, int xIdPeriodoAnterior, int xIdPeriodoActual, int xIdTipo);
				...
				@Query(value = "SELECT  tblterceros.idCliente,                "
		               ...
		               ,
						nativeQuery = true)
				List<TercerosDTO2> listaCriticaInconsistenciaTodasRutas(int idLocal, int xIdPeriodoAnterior, int xIdPeriodoActual, int xIdTipo);
				...
				@Query(value = "		  SELECT  tblterceros.idCliente,                                                   "
		               ...
		               ,
						nativeQuery = true)
				List<TercerosDTO2> listaCriticaInconsistenciaSinFacturaAnteriorTodasRutas(int idLocal, int xIdPeriodoAnterior, int xIdPeriodoActual, int xIdTipo);
				...
				List<TblTerceros> listaUnTerceroFCH(int idLocal, String idCliente, int idTipoTercero);
				 ...
				 @Query(value = " SELECT tmpSaldo.idLocal,                     "
			              ...
			              + "  ORDER BY 12,10,16 ",
			              nativeQuery = true)
				  List<TercerosDTO2> listaDetalleCortesXRuta(int idLocal, int IdTipoOrden, int idPeriodo, int CuotaVencida, int idRuta);
