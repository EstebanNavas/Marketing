...
//	  List<TblDctosDTO3> listaComprobanteRecaudoDetallado(int idLocal, int idPeriodo); 
	  ...
	  @Query(value = "   SELECT                                                 "          
			  ...
			  + "           IDTIPOORDEN,                                   "          
			  + "           IDORDEN,                                       "          
			  + "           MIN(fechaRegistroTx) AS fechaRegistroTx,       "          
			  ...
			  + "           AND IDTIPO = 4                                 "          
			  + "           AND idCliente = ?3                             "          
			  + "       GROUP BY IDLOCAL, IDTIPOORDEN, IDORDEN             "          
			  + "   ) AS tmpDetalle                                        "          
			  + "       ON tblDctos.IDLOCAL = tmpDetalle.IDLOCAL           "          
			  + "       AND tblDctos.IDTIPOORDEN = tmpDetalle.IDTIPOORDEN  "          
			  + "       AND tblDctos.IDORDEN = tmpDetalle.IDORDEN          "          
			  + "   WHERE                                                  "          
			  + "       tblDctos.IDLOCAL = ?1                              "          
			  + "       AND tblDctos.IDTIPOORDEN = 9                       "          
			  + "       AND tblDctos.idPeriodo IN (                        "          
			  + "           SELECT TOP 6 P2.idPeriodo                      "          
			  + "           FROM bdaquamovil.dbo.tblDctosPeriodo P1        "          
			  + "           INNER JOIN bdaquamovil.dbo.tblDctosPeriodo P2  "          
			  + "               ON P2.idLocal = P1.idLocal                 "          
			  + "           WHERE                                          "          
			  + "               P1.idLocal = ?1                            "          
			  + "               AND P1.idPeriodo = ?2                      "          
			  + "               AND P2.idPeriodo <= P1.idPeriodo           "          
			  + "           ORDER BY P2.idPeriodo DESC                     "          
			  + "       )                                                  "          
