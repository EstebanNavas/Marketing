...
@Controller
public class ReporteLecturasSinExportar {
	...
	@GetMapping("/ReporteLecturasSinExportar")
	public String reporteLecturasApp (HttpServletRequest request,Model model) {
		...
		return "Administrador/LecturasSinExportar";
	}
	
	
	
	@PostMapping("/DescargarReporteLecturasAppSinExportar")
	@ResponseBody
	    ...
	    System.out.println("SI ENTRÓ A  DescargarReporteLecturasApp");
	     ...
	     // Local SI factura sitio
	        ...
	        if (idUsuarioLecturasApp > 0) {
	            ...
	            lista = tblDctosOrdenesService.listaLecturaAppSinExportarxUsuario(
	                    idLocal,
	                    xIdTIpoOrdenTemp,
	                    idPeriodoInt,
	            ...
	            lista = tblDctosOrdenesService.listaLecturaAppSinExportar(
	                    idLocal,
	                    xIdTIpoOrdenTemp,
	                    idPeriodoInt);
	        }
