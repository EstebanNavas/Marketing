...
@Controller
public class ReporteFacturaBotonPagosWompi {
	...
	@GetMapping("/ReporteFacturaBotonPagosWompi")
	public String reporteFacturaWhatsApp (HttpServletRequest request,Model model) {
		...
		return "Reporte/ReporteBotonPagosWompi";
	}
	
	
	
	@PostMapping("/DescargarReporteConsultaBotonPagosWompiFecha")
	@ResponseBody
	public ResponseEntity<Resource>  DescargarReporteRecaudosPeriodoFECHA(@RequestBody Map<String, Object> requestBody, HttpServletRequest request,Model model) throws JRException, IOException, SQLException {
	    ...
	    System.out.println("SI ENTRÓ A  DescargarReporteEstadoProductoNUID");
		   ...
		   String xCharSeparator = File.separator;
            ...
            lista = tblAgendaEventoLogService.listaRepRecaudoBotonPagoWompiFecha(idLocal, idPeriodoInt, fechaFormateada);
	...
	@PostMapping("/DescargarReporteConsultaBotonPagosWompi")
	@ResponseBody
	public ResponseEntity<Resource>  DescargarReporteConsultaEnvioWhasApp(@RequestBody Map<String, Object> requestBody, HttpServletRequest request,Model model) throws JRException, IOException, SQLException {
	    ...
	    System.out.println("SI ENTRÓ A  DescargarReporteConsultaEnvioWhasApp");
		    ...
		    int xIdReporte = 1302; 						//CAMBIAR NUMERO DE REPORTE POR EL CREADO
	     ...
	     // Linux
            ...
            // QUERY PARA ALIMENTAR EL DATASOURCE
            lista = tblAgendaEventoLogService.listaReporteRecaudosBotonPago(idLocal, idPeriodoInt);
