...
public class ReporteSaldoFavor {
	...
	@GetMapping("/ReporteSaldoFavor")
	public String reporteSaldoFavor (HttpServletRequest request,Model model) {
		...
		return "Reporte/ReporteSaldoFavor";
	}
	
	
//	@PostMapping("/DescargarReporteSaldoFavor")
//	public ResponseEntity<Resource> DescargarReporteSaldoFavor(HttpServletRequest request,
...
//		
//
//		System.out.println("idPeriodoooooooooo + " + idPeriodo);
//		
//		int idLocal = usuario.getIdLocal();
//		
//	    int xIdReporte = 1700;
...
//		    params.put("p_titulo", xTituloReporte + " PERIODO# " + idPeriodo);
...
//	    
//	    
//	    List <TblDctosPeriodo> Periodo = tblDctosPeriodoService.ObtenerPeriodo(idLocal, idPeriodo);
//	    
//	    Timestamp FechaFinal = null;
//	    String fechaFinalStr = null;
//	    
//	    // Obtenemos la fechaFinal de la DB
...
//	        fechaFinalStr = dateFormat.format(FechaFinal);
//	    }
//	    
...
//            lista = TblDctosService.listaSaldoFavor(fechaFinalStr, idLocal, xIdTipoOrden, idPeriodo, IndicadorINICIAL, IndicadorFINNAL);
//
//    
...
//		}
	...
	@PostMapping("/DescargarReporteSaldoFavor")
	public ResponseEntity<Resource> DescargarReporteSaldoFavor(@RequestBody Map<String, Object> requestBody, HttpServletRequest request,Model model) throws JRException, IOException, SQLException {
	   ...
	   String xCharSeparator = File.separator;
	    for(TblLocales L : Local) {
		    ...
		    params.put("p_nombreLocal", L.getNombreLocal());
		    params.put("p_nit", L.getNit());
		    params.put("p_titulo", xTituloReporte + " PERIODO# " + idPeriodoInt);
		    params.put("p_direccion", L.getDireccion());
		    params.put("p_idLocal", idLocal);
		    params.put("p_indicadorINI", IndicadorINICIAL);
		    params.put("p_idTipoOrdenINI", IdTipoOrdenINI);
	    ...
	    List <TblDctosPeriodo> Periodo = tblDctosPeriodoService.ObtenerPeriodo(idLocal, idPeriodoInt);
