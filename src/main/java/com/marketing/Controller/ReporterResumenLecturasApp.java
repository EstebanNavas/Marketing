...
@Controller
public class ReporterResumenLecturasApp {
	...
	@GetMapping("/ReporteResumenLecturas")
	public String reporteLecturasApp (HttpServletRequest request,Model model) {
		...
		return "Administrador/ResumenLecturasApp";
	}
	
	
	
	@PostMapping("/DescargarReporteResumenLecturasApp")
	@ResponseBody
	public ResponseEntity<Resource>  DescargarReporteLecturasApp(@RequestBody Map<String, Object> requestBody, HttpServletRequest request,Model model) throws JRException, IOException, SQLException {
	    ...
	    System.out.println("SI ENTRÓ A  DescargarReporteLecturasApp");
		    ...
		    int xIdReporte = 2320; 						//CAMBIAR NUMERO DE REPORTE POR EL CREADO
	     ...
	     // Local SI factura sitio
	        ...
	        if (idUsuarioLecturasApp > 0) {
	            ...
	            lista = tblDctosOrdenesService.listaLecturaResumenAppxUsuario(
	                    idLocal,
	                    xIdTIpoOrdenTemp,
	                    idPeriodoInt,
	            ...
	            lista = tblDctosOrdenesService.listaLecturaResumenApp(
	                    idLocal,
	                    xIdTIpoOrdenTemp,
	                    idPeriodoInt);
	        }
