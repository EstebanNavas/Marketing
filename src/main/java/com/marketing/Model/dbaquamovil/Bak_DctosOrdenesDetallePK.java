...
public class Bak_DctosOrdenesDetallePK implements Serializable {
	...
	public Bak_DctosOrdenesDetallePK() {
		super();
	}
	public Bak_DctosOrdenesDetallePK(Integer IDLOCAL,  Integer IDTIPOORDEN, Integer IDORDEN, Integer IDPLU) {
		super();
