...
public class TblTercerosService {
	...
	public List<TercerosDTO> listaTodosLosClientesEstadoFacturaActRUTA(int idLocal, int idPeriodo, int idRuta){
		
		List<TercerosDTO> lista = tblTercerosRepo.listaTodosLosClientesEstadoFacturaActRUTA(idLocal, idPeriodo, idRuta);
	...
	public List<TercerosDTO2> listaDetalleCortesXRuta(int idLocal, int IdTipoOrden, int idPeriodo, int CuotaVencida, int idRuta){
		
		
		List<TercerosDTO2> lista = tblTercerosRepo.listaDetalleCortesXRuta(idLocal, IdTipoOrden, idPeriodo, CuotaVencida, idRuta);
